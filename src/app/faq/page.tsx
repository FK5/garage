  ...
  return (
    <div className="sm:px-20 px-5 py-12 bg-white">
      <div className="flex flex-col">
        ...
        <div className="mb-12">
          <p className="text-black font-bold text-xl sm:text-2xl mb-4">- How often should I change the oil? </p>
        ...
        <div className="mb-12">
          <p className="text-black font-bold text-xl sm:text-2xl mb-4">- How long should one drive below 100 kilometers per hour after refurbishing the engine? </p>
          <p className="text-black text-lg sm:text-xl">500km at least.</p>
        </div>
        <div className="mb-12 sm:mb-24">
          <p className="text-black font-bold text-xl sm:text-2xl mb-4">- If I change any hose in the car, will it leak again? </p>
