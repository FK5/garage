...
export default function InfoBar() {
  ...
  return (
    <>
      <div className="infobar dark:text-black bg-white sm:flex z-50 flex-row border-b-2 border-black h-14 hidden">
      ...
      <div className="bg-white flex dark:text-black flex-col z-50 items-center justify-center block sm:hidden w-full">
        ...
        <a className="text-center flex py-1 border-b-2 border-black w-full flex items-center justify-center text-red-500">
