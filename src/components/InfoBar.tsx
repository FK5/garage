...
export default function InfoBar() {
    return (
        <>
            <div className='infobar bg-white sm:flex z-50 flex-row border-b-2 border-black h-14 hidden'>
            ...
            <div className='bg-white flex flex-col z-50 items-center justify-center block sm:hidden w-full'>
