...
export default function WorkProcessSection() {
    ...
    const processes = [
        {title:"01. REQUEST YOUR QUOTE", description: "We will be there when you most need us", icon:<QuestionMarkCircleIcon height="30px"/>, isRed: false},
        {title:"02. BRING YOUR VEHICLE", description: "We are car guys at heart", icon:<TruckIcon height="30px"/>, isRed: false},
        {title:"03. GET IT REPAIRED", description: "High quality, low cost car servicing", icon:<CheckCircleIcon height="30px"/>, isRed: false},
        {title:"04. VIEW IT LIVE", description: "View our progress with our 24/7 live feed", icon:<VideoCameraIcon height="30px"/>, isRed: true},
    ]
    return (
        <>
                ...
                <div className="flex h-[40rem]">
                    ...
                    <div className="w-1/2 pl-14">
                        ...
                        {processes.map((process, index) => {
                            return (
                                <>
                                    <div key={index} className={`flex flex-start items-center py-6 ${process.isRed ? "text-red-500 hover:font-bold hover:cursor-pointer": ""}`}>
                                        <div className="mr-4">
                                            {process.icon}
                                        </div>
            ...
            <div className="bg-white h-[45rem] px-5 sm:px-20 sm:pr-20 block sm:hidden">
                        ...
                        {processes.map((process, index) => {
                            return (
                                <>
                                    <div key={index} className={`flex flex-start items-center py-6 ${process.isRed ? "text-red-500": ""}`}>
                                        <div className="mr-4">
                                            {process.icon}
                                        </div>
                                        <div className="flex flex-col">
