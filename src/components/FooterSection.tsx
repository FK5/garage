    ...
    return (
        <>
            ...
            <div className='sm:hidden flex flex-col items-center justify-center bg-stone-900 px-5'>
                <p className="text-white text-xl text-center font-bold mt-14 mb-4">IF YOU HAVE ANY QUESTIONS, FEEL FREE TO CONTACT US</p>
                {lineBreak}
                <div className="flex justify-center items-center w-full my-8">
                    <PhoneIcon className='h-[3rem] text-white mr-2'/>
                    <div className='flex flex-col'>
                        <p className="text-white text-2xl text-center font-bold mb-2">961 76 94 95 98</p>
                        <p className="text-white text-2xl text-center font-bold">961 70 81 36 66</p>
                    </div>
                </div>
                {lineBreak}
                ...
                <div className="flex justify-center items-center text-center w-full mt-8 mb-8">
                    <div className='flex flex-col'>
                        ...
                        <p className="text-white mb-2 text-sm">NEW JNAH, 1298 ALI MOKDAD</p>
                        <p className='text-white mb-2 underline text-sm'>GET DIRECTION</p>
                    </div>
                </div>
                {lineBreak}
